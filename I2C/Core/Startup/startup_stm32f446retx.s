...
Reset_Handler:  
  ldr   sp, =_estack      /* set stack pointer */	  //HAL_StatusTypeDef HAL_I2C_Master_Receive(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout);


	  //HAL_I2C_Mem_Read(&hi2c1, 0x1E<<1, 0x34, 1, &r_data, 1, 1000);
